...
awful.screen.connect_for_each_screen(function(s)
    ...
    local slide_right = rubato.timed{
        ...
        intro = 0.14,
        duration = 0.33,
        subscribed = function(pos) control_c.y = s.geometry.y + pos-140 end
    }
        ...
        {
            {
                ...
                spacing = dpi(24)*scalar
            },
            widget = wibox.container.margin,
            margins = dpi(20)*scalar
        },
        {
            statusline,
            margins = {left = dpi(20)*scalar, right = dpi(20)*scalar, bottom = dpi(0)*scalar},
            widget = wibox.container.margin,
        },
        layout = wibox.layout.fixed.vertical,
    }
